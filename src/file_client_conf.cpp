...
ClientConfException::ClientConfException(QString msg) : TSException(msg){
}
...
ClientConf::ClientConf(QString baseUrl, QString confDir, QString number, QObject *parent) : QObject(parent) {
    ...
    this->preKeyStore = FilePreKeyStore(this->confDirPath + QString("/prekeys"), this->confDirPath + QString("/signed_prekeys"), this->keyHelper);
}
